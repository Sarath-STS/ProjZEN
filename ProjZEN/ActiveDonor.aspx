<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="ActiveDonor.aspx.cs" Inherits="ProjZEN.ActiveDonor" %>
...
                <ItemTemplate>
                    <asp:LinkButton ID="lnkviewInvoice" runat="server" OnClick="lnkviewInvoice_Click">Active Donor</asp:LinkButton>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
    </asp:GridView>
