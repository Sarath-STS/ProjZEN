<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="InactiveDonor.aspx.cs" Inherits="ProjZEN.InactiveDonor" %>
...
                <ItemTemplate>
                    <asp:LinkButton ID="lnkviewInvoice" runat="server" OnClick="lnkviewInvoice_Click">INACTIVE DONOR</asp:LinkButton>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
    </asp:GridView>
