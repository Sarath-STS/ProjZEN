<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="ActiveUser.aspx.cs" Inherits="ProjZEN.ActiveUser" %>
...
                <ItemTemplate>
                    <asp:LinkButton ID="lnkviewInvoice" runat="server" OnClick="lnkviewInvoice_Click">Active User</asp:LinkButton>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
    </asp:GridView>
