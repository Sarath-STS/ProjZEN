<%@ Page Title="" Language="C#" MasterPageFile="~/User/Home1.Master" AutoEventWireup="true" CodeBehind="ContactUs.aspx.cs" Inherits="ProjZEN.ContactUs" %>
...
<br />
    <asp:Button class="bt1" ID="Button1" runat="server" Text="Contact" CssClass="btn_style" ForeColor="Black" BorderStyle="Ridge" />
</div>
</div>
<div class="d3">
<div>
...
<div >
    ...
    <br />
        <asp:Button BorderStyle="Ridge" class="bt1" ID="btnsubmit" CssClass="btn_style" ForeColor="Black" runat="server" Text="Submit" />
    </asp:Panel>
</div>
